...
export default function Contato() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 pt-12 pb-24">
      ...
      {/* Grid Principal - Alinhamento Perfeito */}
      <section className="max-w-6xl mx-auto px-6 grid md:grid-cols-12 gap-8 items-stretch">
        
        {/* Lado Esquerdo - Coluna com 2 Cartões */}
        <div className="md:col-span-5 flex flex-col gap-8">
          ...
          {/* Cartão 2: Localização e Rota (Com flex-grow para empurrar o botão pro fundo) */}
          <div className="bg-white p-8 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 flex flex-col items-center text-center flex-grow">
            ...
            {/* O mt-auto aqui é a mágica que cola o botão lá embaixo */}
            <a 
              href="https://maps.google.com/?q=Erechim,+RS" 
              target="_blank"
              rel="noopener noreferrer"
              className="mt-auto w-full bg-slate-900 hover:bg-slate-800 text-white font-bold py-4 rounded-xl transition-all shadow-md shadow-slate-900/20"
            >
        ...
        <div className="md:col-span-7 bg-white p-8 md:p-10 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 h-full flex flex-col">
          ...
          <form onSubmit={enviarWhatsApp} className="flex flex-col flex-grow">
            <div className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-slate-800 focus:outline-none focus:border-slate-900 focus:bg-white transition-all"
                ...
                <div>
                  ...
                  <select 
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-slate-800 focus:outline-none focus:border-slate-900 focus:bg-white transition-all appearance-none"
                  >
              ...
              <div>
                ...
                <textarea 
                  ...
                  rows={5}
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-slate-800 focus:outline-none focus:border-slate-900 focus:bg-white transition-all resize-none"
                  placeholder="Informe as especificações da peça ou projeto..."
                ></textarea>
              </div>
            </div>

            {/* O mt-auto também aqui para colar o botão lá embaixo, alinhado com o da esquerda */}
            <button 
              type="submit" 
              className="mt-auto w-full bg-slate-900 hover:bg-slate-800 text-white font-bold text-lg py-4 rounded-xl transition-all shadow-md shadow-slate-900/20 flex justify-center items-center gap-2 pt-4"
            >
